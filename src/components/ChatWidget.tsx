...
const ChatWidget = memo(() => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 1,
      text: "Peace be unto you! 🙏 Welcome to Celestial Church of Christ, Akoka Parish. How may we assist you on your spiritual journey today?",
      isUser: false,
      timestamp: new Date(),
    },
  ]);
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      const responses = [
        ...
        "Blessings! Our service times are Wednesday 9-10 AM and Sunday 10 AM-2 PM. We would be honored to have you worship with us.",
        ...
        "Holy, Holy, Holy! For inquiries about our programs, please contact us at cccakokaparish@yahoo.com or visit us at Glade Cathedral.",
      ];
