                ...
                <AnimatePresence>
                  {!imageLoaded && (
                    ...
                    >
                      ...
                      {/* Loading text */}
                      <div className="absolute bottom-4 left-1/2 -translate-x-1/2 px-4 py-2 rounded-full bg-white/5">
                        <span className="text-white/50 text-sm" style={{ fontFamily: 'Outfit, sans-serif' }}>Loading...</span>
                      </div>
                    </motion.div>
                  )}
                </AnimatePresence>

                {/* Prophet image - always visible */}
                <img 
                  src={prophetImage}
