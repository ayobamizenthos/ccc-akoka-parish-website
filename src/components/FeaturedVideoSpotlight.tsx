...
import prophetImage from "@/assets/prophet-ademusire-sermon.png";
...
const FeaturedVideoSpotlight = () => {
  ...
  // Featured video data
  const featuredVideo = {
    title: "The Divine Calling - Prophet Segun Ademusire",
    date: "December 1, 2024",
    duration: "1:15:32",
    views: "2.4K",
    youtubeUrl: "https://www.youtube.com/watch?v=dJYeiEP2Zmo",
    description: "Experience a powerful sermon on answering God's divine calling and walking in your spiritual purpose.",
  };
      ...
      >
        ...
        <motion.div className="absolute inset-0 pointer-events-none" style={{ y: backgroundY }}>
          ...
          <motion.div
            ...
            style={{
              background: 'radial-gradient(circle, rgba(45,106,108,0.1) 0%, transparent 60%)',
              filter: 'blur(100px)',
            }}
            animate={{
              scale: [1, 1.2, 1],
          ...
          >
            <div
              ...
              style={{
                ...
                boxShadow: '0 30px 80px rgba(0,0,0,0.2), 0 0 60px rgba(212,175,55,0.08)',
              }}
            >
              {/* Shimmer effect */}
              <motion.div
                ...
                style={{
                  background: 'linear-gradient(120deg, transparent 30%, rgba(212,175,55,0.05) 50%, transparent 70%)',
                }}
                animate={{ x: ['-100%', '200%'] }}
